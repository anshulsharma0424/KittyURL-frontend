...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
  ...
  return (
    <div className={`bg-custom-gradient3 shadow-md hover:shadow-lg border border-card-gradient px-6 sm:py-1 py-3 rounded-md  transition-all duration-100 `}>
    <div className={`flex sm:flex-row flex-col  sm:justify-between w-full sm:gap-0 gap-5 py-5 `}>
      <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden ">
        <div className="text-slate-900 pb-1 sm:pb-0   flex items-center gap-2 ">
            <Link
              target='_'
              className='text-[14px]  font-quicksand font-[600] text-linkColor'
        ...
        <div className="flex items-center gap-1 ">
            <h3 className=" text-slate-700 font-[400] text-[14px] ">
              {originalUrl}
            </h3>
          </div>
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
            ...
            >
                <div className="flex cursor-pointer gap-1 items-center bg-gray-700 py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white ">
            ...
            <div
                ...
                className="flex cursor-pointer gap-1 items-center bg-gray-700 py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white "
            >
